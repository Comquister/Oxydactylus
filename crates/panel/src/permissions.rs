...
pub const ALL_PERMISSIONS: &[(&str, &[&str])] = &[
    ...
    (
        "network",
        &[NETWORK_READ, NETWORK_CREATE, NETWORK_UPDATE, NETWORK_DELETE],
    ),
    (
        "startup",
        &[STARTUP_READ, STARTUP_UPDATE, STARTUP_DOCKER_IMAGE],
    ),
    (
        "database",
        &[
    ...
    (
        "settings",
        &[SETTINGS_RENAME, SETTINGS_REINSTALL, SETTINGS_CHANGE_EGG],
    ),
